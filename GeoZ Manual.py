...
class Controlador:
    def guardar_partida(self, nombre):
        # El controlador obtiene datos de la lógica
        # El controlador envía datos a la Persistencia para el guardado
        # El controlador informa a la vista el resultado
        if self.guardar_partida == True:
...
class Vista:
            ...
            for evento in pygame.event.get():
                if evento.type == pygame.QUIT:
                    ...
                    if evento.key == pygame.K_w:
                        ...
                        self.controlador.guardar_partida("G", self.escenario)
                    elif evento.key == pygame.K_e:
                        resultado = self.jugador.interactuar("E", self.escenario)
                        if resultado:
    ...
    def dibujar_barra_lateral(self):
        ...
        lines.append(f"Guardado: ({'Sí' if self.controlador.guardar_partida else 'No'})")
